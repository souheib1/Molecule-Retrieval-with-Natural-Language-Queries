...
def contrastive_loss(v1, v2, beta=0.9):
...
model = Model(model_name=model_name, num_node_features=300, nout=768, nhid=300, graph_hidden_channels=500, conv_type="GAT", nheads=10) # nout = bert model hidden dim
model.to(device)
